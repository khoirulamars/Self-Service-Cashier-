...
class Transaction:
    ...
    def add_item(self, item_name, qty, item_price):
        if check_add_item(item_name, qty, item_price):
    ...
    def update_item_name(self, item_name, new_item_name):
        try:
            if check_update_item_name(item_name, new_item_name):
    ...
    def update_item_qty(self, item_name, new_qty):
        try:
            if check_update_item_qty(item_name, new_qty):
    ...
    def update_item_price(self, item_name, new_price):
        try:
            if check_update_item_price(item_name, new_price):
    ...
    def calculate_total_price(self):
        for key, _ in self.items.items():
            self.total_price = self.total_price + self.items[key]["total_item_price"]
