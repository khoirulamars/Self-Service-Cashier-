...
def check_add_item(item_name, qty, item_price):
    if type(item_name) is not str:
        print("Nama item harus berupa string, menggunakan tanda petik!")
        return False
...
def check_update_item_name(item_name, new_item_name):
    if type(item_name) is not str:
        print("Nama item harus berupa string, menggunakan tanda petik!")
        return False
    if type(new_item_name) is not str:
        print("Nama item baru harus berupa string, menggunakan tanda petik!")
        return False
    return True

def check_update_item_qty(item_name, new_qty):
    if type(item_name) is not str:
        print("Nama item harus berupa string, menggunakan tanda petik!")
        return False
...
def check_update_item_price(item_name, new_price):
    if type(item_name) is not str:
        print("Nama item harus berupa string, menggunakan tanda petik!")
        return False
